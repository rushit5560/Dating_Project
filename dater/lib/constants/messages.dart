class AppMessages {
  ...
  static String donTLoseAccessToYourAccount = '''Don't lose access to Your account ''';
  static String soWeCanContactYouButItsOptional = '''so We can contact you, But its optional ! ''';
