    ...
    return Expanded(
      child: GridView.builder(
        ...
        gridDelegate:  const SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisSpacing: 19, mainAxisSpacing: 19, crossAxisCount: 2,childAspectRatio: 0.8),
                  ...
                  builder: (BuildContext context){
                    return
                      Obx(() => CustomAlertDialog(
                          ...
                          onPressed: () {Get.to(HomeScreen()); }, onChanged: (index) {
                          favoriteScreenController.change(index);
                        }, activeColor: AppColors.darkOrangeColor, radioButtonText: 'q3tye5ui597',),
                      );
                  }
              ),
              child: Container(
