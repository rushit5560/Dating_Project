...
class ImageSelectModule extends StatelessWidget {
  ...
  final verifyYourAccountScreenController = Get.find<VerifyYourAccountScreenController>();
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        Obx(()=> verifyYourAccountScreenController.imagePath.isEmpty
           ?Container(
            height: 27.h,
            decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(25),
            color: AppColors.darkOrangeColor,
            boxShadow: const [BoxShadow(blurRadius: 7.0,)]),
          )
        : ClipRRect(
         borderRadius: BorderRadius.circular(25),
         child: Image.file(File(verifyYourAccountScreenController.imagePath.value), fit: BoxFit.cover,height: 27.h,width: 46.w,),
         ),),
        SizedBox(height: 4.h,),
        ButtonCustom(
          ...
          onPressed: () {
            verifyYourAccountScreenController.pickImageFromGallery(ImageSource.camera);
          },
