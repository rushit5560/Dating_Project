    ...
    return Column(
      children: [Row(
        mainAxisAlignment: MainAxisAlignment.center,
          children: [Text('''When you tap "Continue", Gather will send you''')]),
        ...
        SizedBox(height: 20.h,),
        Text('Do you have a referral number from a friend?'),
        ButtonCustom(
          //size: Size(double.infinity, 50),
          backgroundColor: AppColors.whiteColor,
          shadowColor: Colors.white,
          text:'\$123456',textColor: AppColors.grey700Color,fontWeight: FontWeight.bold,textsize: 14.sp, onPressed: () {log('message1');},),
